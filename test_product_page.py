...
@pytest.mark.parametrize('link', [0, 1, 2, 3, 4, 5, 6,
                                  pytest.param(7, marks=pytest.mark.skip(reason="Fail test from lesson 4.3")),
                                  8, 9])
...
def test_guest_can_see_not_empty_basket_opened_from_product_page(browser):
...
class TestUserAddToBasketFromProductPage():
    ...
    def setup(self, browser):
        ...
        page = LoginPage(browser, Links.LINK_MAIN_PAGE)
        page.open()
        page.go_to_login_page()
